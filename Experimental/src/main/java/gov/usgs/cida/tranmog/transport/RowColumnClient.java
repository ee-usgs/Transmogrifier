 ...
 * @author eeverman
 */
public class RowColumnClient implements Runnable, ExceptionListener {
	String[] queNames;
	
	public RowColumnClient(String[] queNames) {
	...
	public void run() {
		try {
			...
			Destination destination = session.createQueue(queNames[0]);
